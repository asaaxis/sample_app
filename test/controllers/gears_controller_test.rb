...
class GearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post gears_url, params: { gear: { description: @gear.description, image: @gear.image, name: @gear.name, quantity: @gear.quantity, user_id: @gear.user_id } }
    end
  ...
  test "should update gear" do
    patch gear_url(@gear), params: { gear: { description: @gear.description, image: @gear.image, name: @gear.name, quantity: @gear.quantity, user_id: @gear.user_id } }
